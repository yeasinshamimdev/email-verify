...
const Pagination = (props: PaginationProps) => {
  ...
  const pagerClass = {
    default: 'pagination-pager text-sm font-semibold',
    inactive: 'pagination-pager-inactive text-customVioletSecond',
    active: `text-primary bg-customViolet hover:bg-customViolet dark:bg-${themeColor}-${primaryColorLevel} dark:text-gray-100`,
