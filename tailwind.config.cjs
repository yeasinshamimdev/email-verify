...
const customColors = {
  primary: '#463fa6',
  secondPrimary: "#25224f",
  secondary: '#f6f5ff',
  customRed: '#e53e3e',
  customGreen: '#38a169',
  customGray: 'rgba(0,0,0,.06)',
  customBlack: '#0f172a',
  customPink:"#d278ff",
  customViolet:"#d5d3ed",
  customVioletSecond:"#a8a4e0",
  customVioletThird:"#7e78cc",
};

//custom buttons
export const buttonStyles = {
  base: 'py-2 px-4 rounded-md cursor-pointer text-white font-medium text-base',
